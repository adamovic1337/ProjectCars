<template>
  ...
  <section class="content">
    ...
    <div class="d-flex justify-content-center my-5">
      <div class="row w-50">
        <div class="col-md-7">
          <label for="txtSearchManufacturer" class="form-label"
          ...
          <input
            ...
            type="text"
            class="form-control"
            id="txtSearchManufacturer"
            placeholder="Press Enter for search"
            v-model="manufacturerName"
          />
        </div>
        <div class="col-md-5">
          <label for="ddlManufacturerOrderBy" class="form-label">Order By</label>
          <select
            @change="getData"
            v-model="orderBy"
            id="ddlManufacturerOrderBy"
            class="form-select"
          >
    ...
    <!-- Default box -->
    <div v-if="manufacturers != null" class="d-flex justify-content-center">
    <div class="card w-75">
      <div v-if="Object.keys(manufacturers).length === 0" class="card-header">
        <router-link
          :to="{ name: 'ManufacturerAdd' }"
          class="btn btn-tool"
          title="Add new"
        >
      ...
      <div v-if="Object.keys(manufacturers).length != 0" class="card-body p-0">
